...
namespace GradingTests
{
    ...
    public class GradingTests
    {
        ...
        public class DependencyGraphTest
        {
            ...
            /// <summary>
            /// This test compares two dependency graphs, one built from the other, to show that
            /// they are not the same.
            /// </summary>

            [TestMethod()]
            public void NotEqualTests1()
            {
            ...
            /// <summary>
            /// This test compares two dependency graphs, one built from the other, to show that
            /// they are not the same, and change dependencies differently.
            /// </summary>
            [TestMethod()]
            public void MyTest2()
            {
